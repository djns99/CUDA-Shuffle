...
{
public:
    __host__ DefaultRandomGenerator() : random_function( std::random_device()() )
    {
    }

    __host__ __device__ DefaultRandomGenerator( uint64_t seed ) : random_function( seed )
    {
    }

    __host__ __device__ DefaultRandomGenerator( DefaultRandomGenerator& other )
